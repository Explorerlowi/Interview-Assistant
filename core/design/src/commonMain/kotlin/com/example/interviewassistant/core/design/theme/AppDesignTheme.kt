 ...
 *
 * Maps app tokens into Material3 so existing Compose APIs keep working, while new screens can
 * consume [AppDesign] tokens directly.
 *
...
@Composable
fun AppDesignTheme(
    style: AppDesignThemeStyle = AppDesignThemeStyle.Light,
    ...
    CompositionLocalProvider(
        ...
        MaterialTheme(
            colorScheme = materialColorScheme(colors, style == AppDesignThemeStyle.Dark),
...
internal fun colorsForStyle(style: AppDesignThemeStyle): AppColorTokens {
    return when (style) {
        AppDesignThemeStyle.Light -> LightColors
